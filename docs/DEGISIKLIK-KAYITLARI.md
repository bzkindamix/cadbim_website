...
- **Not:** Bu kalıp (`.form-class input{...appearance:none...}` seçicisinin checkbox'ı da kapsaması) diğer formlarda (iletişim, teklif iste, eğitimler, teknik servis) da riskli olabilir — kapsam dışı bırakıldı, ayrı bir denetim önerilir.
- **Durum:** ✅ Tamamlandı.

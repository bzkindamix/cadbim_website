...
- **2) Sağ kenar sosyal ray (`#print-rail`):** `social-widget.js` v5 çekmece deseninin sağa aynalanmış, sayfaya gömülü kopyası — Instagram `cadbim_print` (doğrulandı), Facebook `cadbimizmir` (print'e özel FB sayfası web aramasında bulunamadı; kurumsal sayfa bağlandı, ayrı sayfa varsa değiştirilecek), WhatsApp `wa.me/905547403757`. Dokunmatikte ilk dokunuş rayı açar; reduced-motion'da geçişler kapalı.

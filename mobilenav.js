...
(function () {
  ...
  var INDEX = [
    ...
    ["DesignJet T200 Serisi", "/designjet-t200", "hp t230 t250 24 inc plotter giris", "Ürün"],
    ["DesignJet T600 Serisi", "/designjet-t600", "hp t630 t650 kucuk ofis plotter", "Ürün"],
    ["DesignJet T830 MFP", "/designjet-t830", "hp t830 tarama kopyalama santiye", "Ürün"],
    ["DesignJet T850", "/designjet-t850", "hp t850 36 inc plotter mfp", "Ürün"],
    ["DesignJet T950", "/designjet-t950", "hp t950 36 inc istifleyici plotter", "Ürün"],
    ["DesignJet Smart Tank", "/designjet-smart-tank", "hp t858 t908 murekkep tank dusuk maliyet", "Ürün"],
    ["DesignJet T1600", "/designjet-t1600", "hp t1600 departman cift rulo plotter", "Ürün"],
    ["DesignJet T1700", "/designjet-t1700", "hp t1700 44 inc gis harita plotter", "Ürün"],
    ["DesignJet T2600 MFP", "/designjet-t2600", "hp t2600 tarama kopyalama departman", "Ürün"],
    ["DesignJet T1600 Plus Edition", "/designjet-t1600-plus", "hp t1600 plus build connected workspace bulut plotter yeni", "Ürün"],
    ["DesignJet T2600 MFP Plus Edition", "/designjet-t2600-plus", "hp t2600 plus build connected vektorizasyon qr tarama yeni", "Ürün"],
    ["DesignJet XL 3600", "/designjet-xl3600", "hp xl 3600 dayanikli uretim mfp", "Ürün"],
    ["DesignJet XL 3800", "/designjet-xl3800", "hp xl 3800 en hizli 6 a1 dakika", "Ürün"],
    ["DesignJet Z6810", "/designjet-z6810", "hp z6810 42 inc uretim fotograf", "Ürün"],
    ["DesignJet Z6 Pro", "/designjet-z6pro", "hp z6 pro 64 inc grafik uretim", "Ürün"],
    ["DesignJet Z9+ Pro", "/designjet-z9pro", "hp z9 pro 64 inc fine art 12 murekkep", "Ürün"],
    ["DesignJet Z6 PostScript", "/designjet-z6ps", "hp z6 ps grafik harita pixel control", "Ürün"],
    ["DesignJet Z9+ PostScript", "/designjet-z9ps", "hp z9 ps fotograf fine art studyo", "Ürün"],
    ["DesignJet HD Pro 2 Tarayıcı", "/designjet-hd-pro", "hp hd pro 2 42 inc buyuk format tarayici", "Ürün"],
    ["DesignJet SD Pro 2 Tarayıcı", "/designjet-sd-pro", "hp sd pro 2 44 inc buyuk format tarayici", "Ürün"],
    ...
    ["HP Z1 G1i", "/hp-z1-g1i", "hp z1 g1i masaustu is istasyonu giris seviye cad", "Ürün"],
    ["HP Z2 G1i", "/hp-z2-g1i", "hp z2 g1i masaustu is istasyonu cad", "Ürün"],
    ["HP Z2m G1i", "/hp-z2m-g1i", "hp z2m g1i mini masaustu is istasyonu cad", "Ürün"],
    ["HP Z4 G5", "/hp-z4-g5", "hp z4 g5 masaustu is istasyonu tek islemci cad", "Ürün"],
    ["HP Z6 G5", "/hp-z6-g5", "hp z6 g5 masaustu is istasyonu cift islemci cad", "Ürün"],
    ["HP Z6 G5 A", "/hp-z6-g5-a", "hp z6 g5 a masaustu is istasyonu cad", "Ürün"],
    ["HP Z8 G5", "/hp-z8-g5", "hp z8 g5 masaustu is istasyonu simulasyon render", "Ürün"],
    ["HP Z8 G5 Fury", "/hp-z8-g5-fury", "hp z8 g5 fury masaustu is istasyonu simulasyon render", "Ürün"],
    ["HP ZBook", "/hp-zbook", "hp mobil is istasyonu laptop firefly power studio fury", "Ürün"],
    ["HP ZBook 8 G1i 14", "/hp-zbook-8-g1i-14", "hp zbook 8 g1i 14 mobil is istasyonu giris seviye", "Ürün"],
    ["HP ZBook 8 G1i 16", "/hp-zbook-8-g1i-16", "hp zbook 8 g1i 16 mobil is istasyonu giris seviye", "Ürün"],
    ["HP ZBook 8 G2i 14", "/hp-zbook-8-g2i-14", "hp zbook 8 g2i 14 mobil is istasyonu giris seviye", "Ürün"],
    ["HP ZBook 8 G2i 16", "/hp-zbook-8-g2i-16", "hp zbook 8 g2i 16 mobil is istasyonu giris seviye", "Ürün"],
    ["HP ZBook Fury 16/18 G1i", "/hp-zbook-fury-16-18-g1i", "hp zbook fury 16 18 g1i mobil is istasyonu cad", "Ürün"],
    ["HP ZBook Power zX 16 G1i", "/hp-zbook-power-zx-16-g1i", "hp zbook power zx 16 g1i mobil is istasyonu cad", "Ürün"],
    ["HP ZBook Power zX 16 G2i", "/hp-zbook-power-zx-16-g2i", "hp zbook power zx 16 g2i mobil is istasyonu cad", "Ürün"],
    ["HP ZBook Ultra 14 G1a", "/hp-zbook-ultra-14-g1a", "hp zbook ultra 14 g1a mobil is istasyonu cad", "Ürün"],
